...
@section('title', 'Tambah Konfigurasi MikroTik')

@section('content')
<div class="container-xxl flex-grow-1 container-p-y">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="m-0 font-weight-bold text-primary">Form Tambah Konfigurasi</h5>
                </div>
                <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <select class="form-select @error('port') is-invalid @enderror" id="port" name="port" required>
                                    <option value="8728" {{ old('port', 8728) == 8728 ? 'selected' : '' }}>8728 (API)</option>
                                </select>
                                @error('port')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
